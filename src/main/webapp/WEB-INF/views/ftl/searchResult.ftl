...
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/>
	...
	<script src="http://neworleans.com/mytrip/app/resources/org.apache.wicket.markup.html.WicketEventReference/wicket-event.js" type="text/javascript"></script>
	<script src="http://neworleans.com/mytrip/app/resources/org.apache.wicket.ajax.WicketAjaxReference/wicket-ajax.js" type="text/javascript"></script>
	<script src="http://neworleans.com/mytrip/app/resources/com.vegas.ui.wicket.page.CylleniusWebPage/jqmodalwindow.js" type="text/javascript"></script>
	...
	<script src="http://neworleans.com/mytrip/app/resources/org.apache.wicket.extensions.ajax.markup.html.modal.ModalWindow/res/modal.js" type="text/javascript"></script>
	<link href="http://neworleans.com/mytrip/app/resources/org.apache.wicket.extensions.ajax.markup.html.modal.ModalWindow/res/modal.css" type="text/css" rel="stylesheet"/>
	...
	<script src="http://neworleans.com/mytrip/app/resources/com.vegas.ui.wicket.panel.AthenaModalWindow/vegas_modal.js" type="text/javascript"></script>
...
<body class="globaless" id="transaction">
	...
	<div style="display: none" id="cookieDisabled">
		<div class="jsDetection">
			<p class="bold header m_b10">Get the most out of VEGAS.com .</p>
			<p class="f13 m_b10">You have browser settings that are limiting
				the way the VEGAS.com website looks and behaves. To use VEGAS.com as
				it is intended, you will need to make a few simple adjustments to
				your browser settings.</p>
			<p class="f13">
				(1) <a target="_blank"
					onclick="window.open(this.href,'popup', 'scrollbars=yes,toolbar=no,addressbar=no,statusbar=no,height=500,width=600'); return false;"
					href="/incl/cookies.html">See how to enable cookies</a>.
			</p>
			<p class="f13">
				(2) After you enable your cookies, <a href="../app">please click
					here</a>.
			</p>
		</div>
	</div>
	...
	<noscript>
			<div class="jsDetection"> 
				<p class="bold header m_b10">Get the most out of VEGAS.com . </p>
				<p class="f13 m_b10"> 
					You have browser settings that are limiting the way the VEGAS.com 
					website looks and behaves. To use VEGAS.com as it is intended, you will 
					need to make a few simple adjustments to your browser settings. 
				</p> 
				<p class="f13"> (1) 
					<a href="/incl/javascript.html" target="_blank">
						See how to enable JavaScript</a>. 
				</p> 
				<p class="f13"> (2) After you enable JavaScript, 
					<a href="../app">please click here</a>.
				</p> 
		</div>
	</noscript>
	<!-- / javascript and cookies disabled messaging -->
		...
		<!-- page content -->
			...
			<div class="summaryCol">
				...
				<div style="width: 200px; height: 265px; margin-top: -10px;">
					<script
						src="http://ad.doubleclick.net/adj/neworleans.com/hotelsearch;sz=200x265;sidebar=100;ord=5360199?"
			...
			<div class="searchContent" id="devSearchContent">
				...
				<div id="id139">
					...
					<h2>Select a New Orleans Hotel</h2>
					<h3 class="bookTitle">

						<span style="color: red;">Get your Room Now!</span> Rooms sell out
						quickly.
					</h3>
					<div class="promoSpot" id="promotionPanel">
						<script
							src="http://ad.doubleclick.net/adj/neworleans.com/hotelsearch;sz=720x90;ad_slot=1;ord=5360199?"
							type="text/javascript"></script>
						<script></script>
					...
					<div class="sortBar">
						<form action="../" name="eventSortOption">
							<ul>
								...
								<li><input id="sortByWeight" type="radio" checked="checked" value="radio0" class="checkBox wicket-sortByGroupf2"
									name="browseItems:sortByGroup"/> 
										<label for="sortByWeightf3">NewOrleans.com Picks </label>&nbsp;
								</li>
								<li><input type="radio" value="radio1" id="sortByPrice" class="checkBox wicket-sortByGroupf2"
									name="browseItems:sortByGroup"/> 
									<label for="sortByPrice">Price </label>&nbsp;
								</li>
								<li><input type="radio" value="radio2" id="sortByNamef5" class="checkBox wicket-sortByGroupf2"
									name="browseItems:sortByGroup"/> 
									<label for="sortByNamef5">Hotel Name </label>&nbsp;
								</li>
								<li><input type="radio" value="radio3" id="sortByRatingf6" class="checkBox wicket-sortByGroupf2"
									name="browseItems:sortByGroup"/> 
									<label for="sortByRatingf6">Rating </label>
								</li>
							</ul>
						</form>
					...
					<div>
						...
						<div class="searchResult">
							...
							<div class="searchResultsHead">
								...
								<h2 class="averageRate">Lowest Average Price:
									<span style="" class="averageRate">$67.</span><span style="" class="averageRate">51</span>
								</h2>
								...
								<div class="productSummary">
									<p>
										<img width="71" height="14" alt="Star Rating" src="http://www.neworleans.com/common/images/star_2_0.gif"/>${hotel.hotelDetails.areaDescription!''}
											(<a href="${hotel.hotelDetails.mapUrl!''}">Map</a>)&nbsp;<a href="#">Photos</a>&nbsp;
									</p>
									<p>
										${hotel.hotelDetails.description!''}
									</p>	
									<p>
										<a href="#">more hotel info</a>
									</p>
									<div>
										<img width="82" height="17" border="0" alt="" 
										 src="http://www.neworleans.com/images/BEU-ticket-2.png" 
										 style="vertical-align:middle;"/>&nbsp;
										<strong>Food, Drinks and more with the 
										 <a onclick="window.open(this.href, 'promos', 'width=760,height=620,scrollbars=yes,resizable=yes'); return false;" 
										    href="http://www.neworleans.com/promotions/bigeasyupgrade/popup.html">Big Easy Upgrade</a>!</strong>
									</div>
									<a style="display:none;" 
									  href="http://www.neworleans.com?cm_re=20121220-_-${hotel.name!''}-_-Slot+1||2">
									 </a>
									<p></p>
								</div>
							</div>
							...
							<div>
					    		...
					    		<tr class="cyl-HotelRow hasPromos  hasSale">
										<td rowspan="1" class="productCol">
											<a class="showRoomDetail" href="#">${roomType.name!''}</a>
											<br/>
				...
				<div id="mwplaceholder">
					<div style="display: none" class="CSScontainer" id="CSScontainer">
						<div class="container_top">
							...
							<div class="round2 round_all"></div>
							<div class="round3 round_all"></div>
							<div class="round4 round_all"></div>
						</div>
						<div id="mwcontent" class="content">some content here</div>
						<div class="container_top">
							<div class="round4 round_all"></div>
							<div class="round3 round_all"></div>
							<div class="round2 round_all"></div>
						...
						<div class="bottom_round">
							<div class="point_round_left"></div>
							<div class="point_round_center"></div>
							<div class="point_round_right"></div>
						</div>
						<div class="point">
							<div class="point1 point_all"></div>
							<div class="point2 point_all"></div>
							<div class="point3 point_all"></div>
							<div class="point4 point_all"></div>
							<div class="point5 point_all"></div>
							<div class="point6 point_all"></div>
							<div class="point7 point_all"></div>
							<div class="point8 point_all"></div>
							<div class="point9 point_all"></div>
							<div class="point10 point_all"></div>
							<div class="point11 point_all"></div>
							<div class="point12 point_all"></div>
							<div class="point13 point_all"></div>
							<div class="point14 point_all"></div>
							<div class="point15 point_all"></div>
							<div class="point16 point_all"></div>
							<div class="point17 point_all"></div>
							<div class="point18 point_all"></div>
							<div class="point19 point_all"></div>
							<div class="point20 point_all"></div>
							<div class="point21 point_all"></div>
							<div class="point22 point_all"></div>
							<div class="point23 point_all"></div>
							<div class="point24 point_all"></div>
	...
	<div>
		<div>
			<div typeof="v:Organization"
				xmlns:v="http://rdf.data-vocabulary.org/#" id="footer">
				<div class="footer-top">
					<div class="footer-top-content">
						<img class="year-seal" src="http://www.neworleans.com/images/18yearslarge.png"
							alt="18 years New Orleans experts"/> We are located in
							downtown New Orleans, Louisiana (NOLA) on historic St. Charles
							Avenue - at the center of what's happening in the Crescent City.
							Southern hospitality is in our DNA, and our team is genuinely
							committed to showing visitors the best of the Big Easy. With
							every hotel, tour, cruise, event ticket, or activity you research
							or purchase on our site, you'll get honest recommendations from
							our in-house crew of local experts. We love this city and we
							can't wait to show you a good time! 
					</div>
				</div>
				<div class="footer-container">
					<div class="col1">
						<div class="footer-heading">Payment Information</div>
						We accept the following payment types <img class="accepted-cards"
							src="http://www.neworleans.com/images/cards.png" alt="We accept all major credit cards"/>
							<div class="footer-heading">Security Guarantee</div>
							<p class="security-guarantee">
								<img style="float: left; padding: 5px;"
									src="http://www.neworleans.com/images/hackerpro.png"
									alt="We protect your personal information"/>To protect
									your personal information, we use a wide array of electronic
									and physical safety measures. <a
									onclick="window.open(this.href, 'safe_to_buy', 'width=450,height=450,scrollbars=yes,resizable=yes'); return false;"
									href="http://www.neworleans.com/includes/pop_info_safetobuy.html" rel="nofollow">Learn
										More</a>
							</p>
					</div>
					<div class="col2">
						...
						<p>
							For customer service please call us at:<br/>Toll-Free
								Customer Service (within the U.S.): <span property="v:tel">(855)-639-6756</span><br/>Customer
									Service (international): <span property="v:tel">(504)
										309-1648</span>
						</p>
						<div class="footer-heading">Policies and Copyright
							Information</div>
						<p>
							Use of this website constitutes acceptance of the NewOrleans.com
							<a href="http://www.neworleans.com/about-us/termsofuse.html">Terms of Use</a> and <a
								href="http://www.neworleans.com/about-us/privacy.html">Privacy Policy</a>. We guard your
							privacy and security.
						</p>
						<div class="company-info">
							All contents &copy;
							<div itemtype="http://schema.org/LocalBusiness" itemscope="">
								<span itemprop="name">NewOrleans.Com</span> - <span
									itemprop="description">The Official New Orleans Travel
									Site</span>
								<div itemtype="http://schema.org/PostalAddress" itemscope=""
									itemprop="address">
									<span itemprop="streetAddress">839 St. Charles Ave.
										Suite 305</span> <span itemprop="addressLocality">New Orleans</span>,
									<span itemprop="addressRegion">LA</span>
								</div>
								Phone: <span itemprop="telephone">504-309-1004</span> | <a
									href="http://www.neworleans.com" itemprop="url">www.neworleans.com</a>
							</div>
						</div>
						<p class="cyllenius">Powered By:</p>
						<span typeof="v:Geo" style="display: none;"> <span
							content="29.945136" property="v:latitude"></span> <span
							content="-90.072055" property="v:longitude"></span>
						</span>
					</div>
					<div class="col3">
						<span class="footer-heading"><a href="/sitemap/">Site
								Map</a></span><br/><ul class="firstList">
								<li><a class="bulleted"
									href="http://www.neworleans.com/new-orleans-hotels/">Hotels</a></li>
								<li><a class="bulleted"
									href="http://www.neworleans.com/new-orleans-tips/group-travel/">Group
										Travel</a></li>
								<li><a class="bulleted"
									href="http://www.neworleans.com/new-orleans-vacation-packages/">Air
										+ Hotel</a></li>
								<li><a class="bulleted"
									href="http://www.neworleans.com/new-orleans-tours/">Tours /
										Activities</a></li>
								<li><a class="bulleted"
									href="http://www.neworleans.com/la/restaurants/">Dining</a></li>
							</ul>
							<ul class="secondList">
								<li><a class="bulleted"
									href="http://www.neworleans.com/new-orleans-deals/">Deals</a></li>
								<li><a class="bulleted"
									href="http://www.neworleans.com/new-orleans-events/">Festivals
										/ Events</a></li>
								<li><a class="bulleted"
									href="http://www.neworleans.com/blog/">NewOrleans.com Blogs</a></li>
								<li><a class="bulleted"
									href="http://www.neworleans.com/about-us/">About Us</a></li>
								<li><a class="bulleted"
									href="http://www.neworleans.com/new-orleans-tips/maps/">Maps</a></li>
							</ul>
							<div class="travel-guide">
								<img src="http://www.neworleans.com/images/guide.png" alt="Free Travel Guide"/>
									<div class="footer-heading">Free Travel Guide</div> <a
									class="bulleted"
									href="http://pages.reply.shop.neworleans.com/page.aspx?QS=773ed3059447707d7e52647881115fcaf053f0855bc772e6781e5a23db264caf">Get
										the Best Travel Deals</a>
							</div>
					</div>
				</div>
			</div>
	...
	<div class="tooltip"
		style="background: transparent url(/common/images/tooltip_left.png) no-repeat top left; padding-bottom: 6px; color: #f8f8f8; display: none; position: absolute;">
		<div
			style="background: transparent url(/common/images/tooltip_right.png) no-repeat top right; padding-right: 5px; padding-left: 5px;">
			<div
				style="font-size: 11px; font-family: Arial, Helvetica, sans-serif; letter-spacing: .05em; padding: 4px 0px; background-color: #444444; zIndex: 40000"></div>
		</div>
	</div>
	<div
